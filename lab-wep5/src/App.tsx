                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-8">
                    ...
                    <div className="flex gap-2">
                        <select 
                            ...
                            className="border rounded-lg px-3 py-2 dark:bg-gray-800 dark:text-white border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
                        >
