  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 p-8 space-y-12">
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-semibold border-b pb-2 text-gray-800 dark:text-gray-200">Buttons</h2>
        
        {/* Varyant 1: Primary + Renkler */}
      ...
      <section className="space-y-4 max-w-md">
        <h2 className="text-2xl font-semibold border-b pb-2 text-gray-800 dark:text-gray-200">Inputs</h2>
      ...
      {/* CARDS */}
      <section className="space-y-4">
        <h2 className="text-2xl font-semibold border-b pb-2 text-gray-800 dark:text-gray-200">Cards</h2>
      ...
      <section className="space-y-4 max-w-xl">
        <h2 className="text-2xl font-semibold border-b pb-2 text-gray-800 dark:text-gray-200">Alerts</h2>
